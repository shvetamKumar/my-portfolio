...
class SmoothScroll {
    ...
    handleClick(e) {
        ...
        if (targetSection) {
            const offsetTop = targetSection.offsetTop - 80; // Account for fixed nav + extra space
            window.scrollTo({
                top: offsetTop,
                behavior: 'smooth'
            });
...
class ProfessionalInteractions {
    ...
    init() {
        ...
        this.addViewWorkButtonHandler();
        this.addGetInTouchButtonHandler();
        ...
        if (viewWorkBtn) {
            viewWorkBtn.addEventListener('click', (e) => {
                ...
                if (experienceSection) {
                    const offsetTop = experienceSection.offsetTop - 80; // Extra space for Work Experience heading
                    window.scrollTo({
                        top: offsetTop,
                        behavior: 'smooth'
                    });
    ...
    addGetInTouchButtonHandler() {
        ...
        if (getInTouchBtn) {
            getInTouchBtn.addEventListener('click', (e) => {
                ...
                if (contactSection) {
                    const offsetTop = contactSection.offsetTop - 100; // Space for Contact section heading
                    window.scrollTo({
                        top: offsetTop,
                        behavior: 'smooth'
                    });
